...
public:
	...
	{
		process<uint8_t, uint8_t>(src, dst, DitherPolicySSE2{}, UnpackByteSSE2{}, PackByteSSE2{},
	...
	{
		process<uint8_t, uint16_t>(src, dst, DitherPolicySSE2{}, UnpackByteSSE2{}, PackWordSSE2{},
		                           make_integer_to_float_sse2(src.format), make_float_to_integer_sse2(dst.format),
	...
	{
		process<uint16_t, uint16_t>(src, dst, DitherPolicySSE2{}, UnpackWordSSE2{}, PackWordSSE2{},
		                            make_integer_to_float_sse2(src.format), make_float_to_integer_sse2(dst.format),
	...
	{
		process<float, uint8_t>(src, dst, DitherPolicySSE2{}, UnpackFloatSSE2{}, PackByteSSE2{},
	...
	{
		process<float, uint16_t>(src, dst, DitherPolicySSE2{}, UnpackFloatSSE2{}, PackWordSSE2{},
		                         identity<__m128>, make_float_to_integer_sse2(dst.format),
